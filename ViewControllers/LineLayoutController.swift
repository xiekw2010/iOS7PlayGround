...
class LineLayoutController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.registerClass(ThumbnailCollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
